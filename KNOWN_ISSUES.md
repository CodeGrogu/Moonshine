...
- **Status**: Verified (253 unit and integration tests passed across `Moonshine.Protocol.Tests` (71), `Moonshine.Core.Tests` (70), `Moonshine.Interop.Tests` (68), `Moonshine.Host.Tests` (44)).
