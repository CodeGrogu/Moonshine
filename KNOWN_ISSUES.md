...
- **Status**: Verified (257 unit and integration tests passed across `Moonshine.Protocol.Tests` (71), `Moonshine.Core.Tests` (70), `Moonshine.Interop.Tests` (72), `Moonshine.Host.Tests` (44)).
