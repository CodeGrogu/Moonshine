...
- **Status**: Verified (235 unit and integration tests passed across `Moonshine.Protocol.Tests` (71), `Moonshine.Core.Tests` (65), `Moonshine.Interop.Tests` (55), `Moonshine.Host.Tests` (44)).
