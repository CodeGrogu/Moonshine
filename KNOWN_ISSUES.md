...
- **Status**: Verified (263 unit and integration tests passed across `Moonshine.Protocol.Tests` (71), `Moonshine.Core.Tests` (76), `Moonshine.Interop.Tests` (72), `Moonshine.Host.Tests` (44)).
