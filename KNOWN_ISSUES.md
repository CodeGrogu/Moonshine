...
- **Status**: Verified (266 unit and integration tests passed across `Moonshine.Protocol.Tests` (71), `Moonshine.Core.Tests` (79), `Moonshine.Interop.Tests` (72), `Moonshine.Host.Tests` (44)).
