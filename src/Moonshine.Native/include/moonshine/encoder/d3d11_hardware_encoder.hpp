...
class D3D11HardwareEncoder final : public IVideoEncoder {
public:
    D3D11HardwareEncoder();
    ~D3D11HardwareEncoder() override;
    ...
    [[nodiscard]] EncoderVendor vendor() const noexcept override { return EncoderVendor::Direct3D11Hardware; }
