...
typedef enum _NV_ENC_CAPS {
    ...
    NV_ENC_CAPS_NUM_MAX_TEMPORAL_LAYERS = 9,
    NV_ENC_CAPS_SUPPORT_HIERARCHICAL_PFRAMES = 10,
    NV_ENC_CAPS_SUPPORT_HIERARCHICAL_BFRAMES = 11,
    NV_ENC_CAPS_LEVEL_MAX = 12,
    NV_ENC_CAPS_LEVEL_MIN = 13,
    NV_ENC_CAPS_SEPARATE_COLOUR_PLANE = 14,
    NV_ENC_CAPS_WIDTH_MAX = 15,
    NV_ENC_CAPS_HEIGHT_MAX = 16,
    NV_ENC_CAPS_SUPPORT_TEMPORAL_SVC = 17,
    NV_ENC_CAPS_SUPPORT_DYN_RES_CHANGE = 18,
    NV_ENC_CAPS_SUPPORT_DYN_BITRATE_CHANGE = 19,
    NV_ENC_CAPS_SUPPORT_STORE_INTRA_REFRESH = 20,
    NV_ENC_CAPS_SUPPORT_MULTIPLE_REF_FRAMES = 21,
    NV_ENC_CAPS_SUPPORT_DYNAMIC_SLICE_MODE = 22,
    NV_ENC_CAPS_SUPPORT_REF_PIC_INVALIDATION = 23,
    NV_ENC_CAPS_PREPROC_SUPPORT = 24,
    NV_ENC_CAPS_ASYNC_ENCODE_SUPPORT = 25,
    NV_ENC_CAPS_MB_NUM_MAX = 26,
    NV_ENC_CAPS_MB_PER_SEC_MAX = 27,
    NV_ENC_CAPS_SUPPORT_YUV444_ENCODE = 28,
    NV_ENC_CAPS_SUPPORT_LOSSLESS_ENCODE = 29,
    NV_ENC_CAPS_SUPPORT_SAO = 30,
    NV_ENC_CAPS_SUPPORT_MEONLY_MODE = 31,
    NV_ENC_CAPS_SUPPORT_LOOKAHEAD = 32,
    NV_ENC_CAPS_SUPPORT_TEMPORAL_AQ = 33,
    NV_ENC_CAPS_SUPPORT_10BIT_ENCODE = 34,
    NV_ENC_CAPS_NUM_MAX_LTR_FRAMES = 35,
    NV_ENC_CAPS_SUPPORT_WEIGHTED_PREDICTION = 36,
    NV_ENC_CAPS_SUPPORT_DYNAMIC_SLICE_INTRAREFRESH = 37,
    NV_ENC_CAPS_SUPPORT_INTRA_REFRESH = 38,
    NV_ENC_CAPS_SINGLE_SLICE_INTRA_REFRESH = 39,
    NV_ENC_CAPS_SUPPORT_CUSTOM_VBV_BUF_SIZE = 40,
    NV_ENC_CAPS_DYNAMIC_GOP_LENGTH_SUPPORT = 41,
    NV_ENC_CAPS_SUPPORT_SUBFRAME_READ = 42,
    NV_ENC_CAPS_WIDTH_MIN = 49,
    NV_ENC_CAPS_HEIGHT_MIN = 50,
} NV_ENC_CAPS;
...
#define NV_ENC_CAPS_PARAM_VER (NVENCAPI_STRUCT_VERSION(1) | (1u << 31))
...
typedef NVENCSTATUS(NVENCAPI* PNVENCGETENCODEPROFILEGUIDCOUNT)(void*, GUID, uint32_t*);
typedef NVENCSTATUS(NVENCAPI* PNVENCGETENCODEPROFILEGUIDS)(void*, GUID, GUID*, uint32_t, uint32_t*);
typedef NVENCSTATUS(NVENCAPI* PNVENCGETENCODECAPS)(void*, GUID, NV_ENC_CAPS_PARAM*, int32_t*);
