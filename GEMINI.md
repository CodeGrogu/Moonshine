...
- **Overseer Subagent Governance**: Overseer governs specialized subagents (`researcher`, `implementer`, `adversary`, `test-writer`, `script-runner`, `specialist`, `adversarial-claim-checker`, `adversarial-verification-implementer`, `edge-case-checker`, `edge-case-implementer`). The adversarial-claim-checker must be satisfied before any milestone or claim can advance. Work is mandatorily delegated to subagents.
