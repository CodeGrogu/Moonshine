...
- **Overseer & Subagent Orchestration**: The primary agent functions as the Overseer supervising up to six specialized subagents (`researcher`, `implementer`, `adversary`, `test-writer`, `script-runner`, and `specialist`). The Overseer must delegate tasks to subagents without exception.
