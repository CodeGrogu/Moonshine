...
- **Overseer & Subagent Orchestration**: The primary agent functions as the Overseer supervising specialized subagents (`researcher`, `implementer`, `adversary`, `test-writer`, `script-runner`, `specialist`, `adversarial-claim-checker`, `adversarial-verification-implementer`, `edge-case-checker`, `edge-case-implementer`, `documentation-upholder`, `vendor-implementer`) and domain advisors (`directx-specialist`, `cpp-specialist`, `csharp-specialist`, `architectural-specialist`, `networking-specialist`, `dynamic-vendor-specialist`). The adversarial-claim-checker must be satisfied before any milestone or claim can advance. The Overseer must delegate tasks to subagents without exception.
