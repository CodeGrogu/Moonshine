...
- **Orchestrator Leadership & Subagent Coordination**: The primary agent functions as the central Orchestrator and Coordinator, leading and actively directing the entire subagent and specialist advisor collective. The Orchestrator evaluates user objectives, routes specific tasks to the appropriate specialized subagents (`researcher`, `implementer`, `adversary`, `test-writer`, `script-runner`, `specialist`, `adversarial-claim-checker`, `adversarial-verification-implementer`, `edge-case-checker`, `edge-case-implementer`, `documentation-upholder`, `vendor-implementer`) and domain advisors (`directx-specialist`, `cpp-specialist`, `csharp-specialist`, `architectural-specialist`, `networking-specialist`, `dynamic-vendor-specialist`), coordinates concurrent background execution, and maintains continuous agent activity. The adversarial-claim-checker must be fully satisfied before any milestone or claim can advance. The Orchestrator must delegate tasks without exception.
