...
- **Script Timing & Polling Discipline**: When running scripts with estimated duration $T$, set timer duration between $\frac{1}{2} T$ and $3 \times T$, checking at most once, twice, or thrice per script run.
